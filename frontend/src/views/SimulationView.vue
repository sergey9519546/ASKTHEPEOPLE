...
.view-mode-selector { display: flex; border: 4px solid var(--atp-black); background: var(--atp-light-gray); padding: 4px; gap: 4px; }
.mode-btn { 
...
.workbench-header { height: 50px; border-bottom: 4px solid var(--atp-black); display: flex; align-items: center; padding: 0 20px; background: var(--atp-light-gray); }
