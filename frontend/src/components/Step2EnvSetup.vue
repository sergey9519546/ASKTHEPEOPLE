          ...
          >
            ...
            <div class="narrative-box">
              <span class="box-label"
                ...
                <span class="special-icon">✦</span></span
              >
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    ...
    addLog(`Initiating simulation with custom rounds: ${customMaxRounds.value}`);
  } else {
    addLog(`Initiating simulation with auto-config rounds: ${autoGeneratedRounds.value}`);
  }
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (res.data.expected_entities_count) {
        ...
        addLog(
          `Read ${res.data.expected_entities_count} entities from Graph`,
        );
      }
    ...
    if (res.success && res.data) {
      ...
      if (data.config_generated && data.config) {
        ...
        if (data.summary) {
          ...
          addLog(`  └─ Platform Status: X ${data.summary.has_twitter_config ? "✓" : "✗"}, Reddit ${data.summary.has_reddit_config ? "✓" : "✗"}`);
        }
