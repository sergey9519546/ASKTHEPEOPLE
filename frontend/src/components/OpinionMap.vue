...
const latestOpinions = computed(() => {
  const map = new Map();
  // ⚡ Bolt Optimization:
  // Direct string comparison of ISO 8601 timestamps eliminates O(N log N) `Date` object creations.
  // This significantly reduces CPU usage and GC overhead during re-renders.
