...
class ZepEntityReader:
    ...
    2. Filter nodes that match predefined entity types (Labels other than just Entity)
    3. Retrieve related edges and associated node info for each entity
    """
    ...
    def _call_with_retry(
        ...
        Args:
            ...
            max_retries: Maximum number of retries (default 3, including initial attempt)
    ...
    def filter_defined_entities(
        ...
        Filtering logic:
        - If node Labels only contains "Entity", it doesn't match predefined types, skip.
        - If node Labels contains tags other than "Entity" and "Node", it matches, keep.
        
        Args:
            graph_id: Graph ID
            defined_entity_types: List of predefined entity types (optional)
            enrich_with_edges: Whether to retrieve related edge info for each entity
    ...
    def get_entities_by_type(
        ...
        Args:
            ...
            enrich_with_edges: Whether to retrieve related edge info
